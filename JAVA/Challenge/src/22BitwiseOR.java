 ...
 * Description: This program performs the bitwise OR operation on two numbers.
 * Approach:
 * 1. Take two integer inputs from the user.
 * 2. Apply the '|' operator to find the bitwise OR.
...
class BitwiseOR {
    public static void main(String[] args) {
        ...
        System.out.println("Welcome To The Bitwise OR Operation Zone");
       ...
       // int result = firstNumber | secondNumber;
        System.out.println("Bitwise OR Result: " + (firstNumber | secondNumber));
...
/**
 * Program: Bitwise OR Operator
 * Description: Performs the bitwise OR operation on two numbers and shows internal bitwise processing.
 */
...
class BitwiseOR {
    public static void main(String[] args) {
        ...
        System.out.println("OR Result     : " + binaryResult + " (" + result + ")");
